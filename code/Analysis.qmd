...
```{r}
# taux emergence is the ration between the number of adults and the nymphe
...
ggplot(resume_cycle, aes(x = stade, y = moyenne, color = statut, group = statut)) +
  geom_line() +
  geom_point(size = 2) +
  # geom_text(aes(label = moyenne), vjust = -0.6) +
  labs(x = "cycle", y = "nombre moyen") +
  theme_minimal() +
  facet_grid(experience ~ inhibitor) +
...
ggplot(resume_cycle_durations, aes(x = phase, y = moyenne, color = statut, group = statut)) +
  geom_line() +
  geom_point(size = 2) +
  # geom_text(aes(label = moyenne), vjust = -0.6) +
  labs(x = "cycle", y = "duree moyen") +
  theme_minimal() +
  facet_grid(experience ~ inhibitor) +
  theme(axis.text = element_text(angle = 45)) +
